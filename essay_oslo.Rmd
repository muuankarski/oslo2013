...
knit("essay_oslo.Rmd")
system("pandoc -t html essay_oslo.md -o essay_oslo.html --standalone --bibliography=bibtex.bib --number-sections --mathjax")

system("pandoc essay_oslo.md -o essay_oslo.pdf --bibliography=bibtex.bib --number-sections --latexmathml --variable=geometry:a4paper")
