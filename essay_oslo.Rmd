...
# pdf
system("pandoc -s essay_oslo.md -o essay_oslo.tex --toc --number-section --bibliography=bibtex.bib --variable=geometry:a4paper")
system("pandoc -s essay_oslo.tex -o essay_oslo.pdf --toc --number-section --bibliography=bibtex.bib --variable=geometry:a4paper")
